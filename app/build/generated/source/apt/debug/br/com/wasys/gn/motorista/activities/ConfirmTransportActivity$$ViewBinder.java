...
public class ConfirmTransportActivity$$ViewBinder<T extends br.com.wasys.gn.motorista.activities.ConfirmTransportActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131624123, "field 'txt_valor'");
    target.txt_valor = finder.castView(view, 2131624123, "field 'txt_valor'");
    ...
    view = finder.findRequiredView(source, 2131624125, "field 'btn_recusar'");
    target.btn_recusar = finder.castView(view, 2131624125, "field 'btn_recusar'");
    view = finder.findRequiredView(source, 2131624120, "field 'txt_tipo_corrida'");
    target.txt_tipo_corrida = finder.castView(view, 2131624120, "field 'txt_tipo_corrida'");
  }
  ...
  @Override public void unbind(T target) {
    ...
    target.btn_recusar = null;
    target.txt_tipo_corrida = null;
  }
}
