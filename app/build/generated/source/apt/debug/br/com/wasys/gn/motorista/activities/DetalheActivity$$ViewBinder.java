...
public class DetalheActivity$$ViewBinder<T extends br.com.wasys.gn.motorista.activities.DetalheActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131624127, "field 'mMapaImageView'");
    target.mMapaImageView = finder.castView(view, 2131624127, "field 'mMapaImageView'");
